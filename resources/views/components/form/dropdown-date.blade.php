...
<div class="dropdown dropdown-center w-full h-full">
    <div tabindex="0" role="button" class="btn btn-ghost h-full w-full hover:bg-[#561227] transition text-white font-bold tooltip tooltip-bottom" data-tip="Filtrar fechas">{{ $title }}</div>
