        ...
        <ul tabindex="0" class="dropdown-content absolute left-1/2 top-full mt-2 -translate-x-1/2 p-2 shadow bg-base-100 rounded-box w-72 z-[1]">
            <li>
                <div class="grid gap-2">
                    <button wire:click.prevent="$emit('emitExcel')" class="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 transition">
                    ...
                    <button wire:click.prevent="$emit('emitPdf')" class="flex items-start gap-3 p-3 rounded-lg hover:bg-gray-50 transition">
