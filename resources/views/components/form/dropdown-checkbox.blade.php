...
<div class="dropdown dropdown-center w-full h-full">
    <div tabindex="0" role="button" class="btn btn-ghost h-full w-full hover:text-white hover:bg-[#561227] transition font-bold tooltip tooltip-bottom" data-tip="Buscar tickets por {{ $title }}">{{ $title }}</div>
